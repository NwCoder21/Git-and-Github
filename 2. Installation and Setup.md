...
![image](https://user-images.githubusercontent.com/107522496/212785469-b187ba99-c115-454a-9344-d78a5195a4b0.png)

Here, it does not have one already so let's configure one.

---

![image](https://user-images.githubusercontent.com/107522496/212785488-fe19bd65-322f-46d8-88ac-d3fa938cc00a.png)
...
To configure my name as Nw `Coder21`. When we then press `Enter`, nothing really happens. So run: 

```yaml
$ git config user.name
```

to confirm that chnages have been made. We can now see that the name has been updated.
